...
public class DateUtil {
    ...
    private static int[] randomCommon(int max, int n) {
        if (n > (max + 1)) {
            return null;
        }
    ...
    private static final SimpleDateFormat mFormatTradeEasyProduct = new SimpleDateFormat(
            "dd/MM/yyyy");
    private static final String mFormatExpire = "MMMM dd, yyyy";
    private static final SimpleDateFormat esFormatTime = new SimpleDateFormat(
    ...
    private static final String sdfLongCn = "yyyy年MM月dd日";
    private static final String sdfShortU = "MMM dd";
    private static final String sdfLongU = "MMM dd,yyyy";
    private static final String sdfLongTime = "yyyyMMddHHmmss";
    private static final String sdfLongTimePlus = "yyyy-MM-dd HH:mm:ss";
    private static final String sdfLongTimePlusMillNew = "yyyy-MM-dd'T'HH:mm:ss.SSS Z";
    ...
    // 读取Long类型TImestamp转换为Date
    public static Long get10LongFromDate(Date date) {
        return date.getTime() / 1000L;
    }

    // 读取Long类型TImestamp转换为Date
    public static Date change10LongToDate(Long long10) {
        Long long13 = null == long10 ? null : Long.valueOf(new StringBuffer(long10.toString()).append("000").toString());
        Date date = new Date();
        date.setTime(long13);
        return date;
    }
    ...
    public static String getDateLong(Date date) {
        ...
        try {
            if (date != null) {
                nowDate = new SimpleDateFormat(sdfLong).format(date);
            }
            return nowDate;
        } catch (Exception e) {
    ...
    public static String getDateLongCn(Date date) {
        ...
        try {
            if (date != null) {
                nowDate = new SimpleDateFormat(sdfLongCn).format(date);
            }
            return nowDate;
        } catch (Exception e) {
            System.out.println("Error at getDate:" + e.getMessage());
    ...
    public static String getDateMD(Date date) {
        ...
        try {
            if (date != null) {
                nowDate = new SimpleDateFormat(sdfMd).format(date);
            }
            return nowDate;
        } catch (Exception e) {
            System.out.println("Error at getDate:" + e.getMessage());
    ...
    public static String getDateShortLongTimeCn(Date date) {
        ...
        try {
            if (date != null) {
                nowDate = new SimpleDateFormat(sdfShortLongTimePlusCn).format(date);
            }
            return nowDate;
        } catch (Exception e) {
            System.out.println("Error at getDate:" + e.getMessage());
    ...
    public static String getDateUS(Date date) {
        ...
        try {
            if (date != null) {
                nowDate = new SimpleDateFormat(sdfLongU, Locale.ENGLISH).format(date);
            }
            return nowDate;
        } catch (Exception e) {
            System.out.println("Error at getDate:" + e.getMessage());
    ...
    public static String getDateUSShort(Date date) {
        ...
        try {
            if (date != null) {
                nowDate = new SimpleDateFormat(sdfShortU, Locale.ENGLISH).format(date);
            }
            return nowDate;
        } catch (Exception e) {
            System.out.println("Error at getDate:" + e.getMessage());
    ...
    public static String getNowLongTime() throws Exception {
        ...
        try {
            ...
            nowTime = new SimpleDateFormat(sdfLongTime).format(date);
            return nowTime;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowShortDate() throws Exception {
        ...
        try {
            java.sql.Date date = new java.sql.Date(new Date().getTime());
            nowDate = new SimpleDateFormat(sdfShort).format(date);
            return nowDate;
        } catch (Exception e) {
            throw e;
        }
     ...
     * @throws Exception
     */
    public static Date getNowShortDateByStr(String shortStr) throws Exception {
        try {
            Date nowDate = new SimpleDateFormat(sdfShort).parse(shortStr);
            return nowDate;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowPlusTime() throws Exception {
        ...
        try {
            java.sql.Date date = new java.sql.Date(new Date().getTime());
            nowDate = new SimpleDateFormat(sdfLongTimePlus).format(date);
            return nowDate;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getPlusTime(Date date) throws Exception {
        ...
        try {
            String nowDate = new SimpleDateFormat(sdfLongTimePlus).format(date);
            return nowDate;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowPlusTimeMill() throws Exception {
        ...
        try {
            java.sql.Date date = new java.sql.Date(new Date().getTime());
            nowDate = new SimpleDateFormat(sdfLongTimePlusMill).format(date);
            return nowDate;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowYear() throws Exception {
        try {
            ...
            String nowYear = strTemp.substring(0, 4);
            return nowYear;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowMonth() throws Exception {
        try {
            String strTemp = getNowLongTime();
            String nowMonth = strTemp.substring(4, 6);
            return nowMonth;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowDay() throws Exception {
        try {
            String strTemp = getNowLongTime();
            String nowDay = strTemp.substring(6, 8);
            return nowDay;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getNowHour() throws Exception {
        try {
            ...
            String nowHour = strTemp.substring(8, 10);
            return nowHour;
        } catch (Exception e) {
            throw e;
        }
    ...
    public static String getTimeBySecond(String _second) throws Exception {
        ...
        try {
            String returnTime = "";
            long longSec = Long.parseLong(_second);
            if (longSec == 0) {
                returnTime = "0时0分0秒";
                return returnTime;
            }
            long longHour = longSec / 3600; // 取得小时数
            longSec = longSec % 3600; // 取得余下的秒
            long longMinu = longSec / 60; // 取得分数
    ...
    public static String getTimeBySecond(long ms_second) throws Exception {
        ...
        try {
            ...
            long longHour = longMs / 3600000; // 取得小时数
            longMs = longMs % 3600000; // 取得余下的毫秒
            long longMinu = longMs / 60000; // 取得分数
            longMs = longMs % 60000; // 取得余下的毫秒
            long longSec = longMs / 1000; // 取得余下的秒
     ...
     * 格式化字符串为时间格式
     */
    public static Date getUTCDateByStr(String str) {
        ...
        try {
            Date date = new SimpleDateFormat(sdfLongTimePlusMillNew).parse(str);
            return date;
    ...
    public static Date getDateByStr(String str) {
        ...
        try {
            Date date = new SimpleDateFormat(sdfLongTimePlus).parse(str);
            return date;
        } catch (ParseException e) {
        }
        try {
            Date date = new SimpleDateFormat(sdfLongTime).parse(str);
            return date;
        } catch (ParseException e) {
        }
        try {
            Date date = new SimpleDateFormat(sdfShortLongTimePlusCn).parse(str);
            return date;
        } catch (ParseException e) {
        }
        try {
            Date date = new SimpleDateFormat(sdfLongTimePlusMill).parse(str);
            return date;
        } catch (ParseException e) {
        }
        try {
            Date date = new SimpleDateFormat(sdfLong).parse(str);
            return date;
        } catch (ParseException e) {
        }
        try {
            Date date = new SimpleDateFormat(sdfLongCn).parse(str);
            return date;
        } catch (ParseException e) {
        }
        try {
            Date date = new SimpleDateFormat(sdfShort).parse(str);
            return date;
        } catch (ParseException e) {
        }
    ...
    public static String getCurrentYearMonth() {
        ...
        String currentMonth;
        if (Integer.parseInt(month.format(cal.getTime())) < 10) {
            currentMonth = "0"
                    + (month.format(cal.getTime()));
        } else {
            currentMonth = month.format(cal.getTime());
        }
    ...
    public static Date stringToDate(String strDate, String oracleFormat) {
        ...
        if (s.indexOf("yyyy") != -1) {
            h.put(Integer.valueOf(s.indexOf("yyyy")), "yyyy");
        } else if (s.indexOf("yy") != -1) {
            h.put(Integer.valueOf(s.indexOf("yy")), "yy");
        }
        if (s.indexOf("mm") != -1) {
            h.put(Integer.valueOf(s.indexOf("mm")), "MM");
        }

        if (s.indexOf("dd") != -1) {
            h.put(Integer.valueOf(s.indexOf("dd")), "dd");
        }
        if (s.indexOf("hh24") != -1) {
            h.put(Integer.valueOf(s.indexOf("hh24")), "HH");
        }
        if (s.indexOf("mi") != -1) {
            h.put(Integer.valueOf(s.indexOf("mi")), "mm");
        }
        if (s.indexOf("ss") != -1) {
            h.put(Integer.valueOf(s.indexOf("ss")), "ss");
        }

        int intStart = 0;
        while (s.indexOf("-", intStart) != -1) {
            intStart = s.indexOf("-", intStart);
            h.put(Integer.valueOf(intStart), "-");
            intStart++;
        }
        ...
        if (s.indexOf("年") != -1) {
            h.put(Integer.valueOf(s.indexOf("年")), "年");
        }
        if (s.indexOf("月") != -1) {
            h.put(Integer.valueOf(s.indexOf("月")), "月");
        }
        if (s.indexOf("日") != -1) {
            h.put(Integer.valueOf(s.indexOf("日")), "日");
        }
        if (s.indexOf("时") != -1) {
            h.put(Integer.valueOf(s.indexOf("时")), "时");
        }
        if (s.indexOf("分") != -1) {
            h.put(Integer.valueOf(s.indexOf("分")), "分");
        }
        if (s.indexOf("秒") != -1) {
            h.put(Integer.valueOf(s.indexOf("秒")), "秒");
        }
        ...
        while (h.size() != 0) {
            ...
            String temp = (String) h.get(Integer.valueOf(n));
            h.remove(Integer.valueOf(n));
    ...
    public static int getAge(String id) throws Exception {
        ...
        age = currentYear - Integer.parseInt(birthday);
        return age;
    }
    ...
    public static String descreaseYearMonth(String yearMonth) {
        ...
        // if(month>12)
        {
            return String.valueOf(year - 1) + ((month + 12));
        }
...
//        String month1 = ym.substring(4);
    ...
    public static String getFormattedDate(String strDate, String strFormatTo) {
        ...
        switch (strDate.trim().length()) {
            ...
            case 11:
                int length = 0;
                try {
                    length = strDate.getBytes("GBK").length;
    ...
    public static String getTimeFormat(long lSecond) {
        ...
        if (lSecond <= 0) {
            ...
            if (minute <= 0) {
                ...
                szTime = szTime + "0" + minute;
            } else {
                szTime = szTime + minute;
            }
            szTime = szTime + ":";
            ...
            if (second <= 0) {
                ...
                szTime = szTime + "0" + second;
            } else {
                szTime = szTime + second;
            }
        }
    ...
    public static int getBetweenDays(String strFromDate, String strToDate) {
        try {
            ...
            return Long.valueOf(llTmp / 1000 / 3600 / 24).intValue();
        } catch (Exception e) {
    ...
    public static Date getDateFromString(String strDate) {
        ...
        try {
            return new SimpleDateFormat(sdfLongTimePlus).parse(strDate);
        } catch (Exception ex) {
            return new Timestamp(System.currentTimeMillis());
        }
    }
    ...
    public static Date parseFromFormats(String aValue) {
        ...
        for (int i = 0; i < formats.length; i++) {
            try {
                return DateUtil.parse(aValue, formats[i]);
            } catch (Exception e) {
            }
        }
        return null;
    ...
    public static String format14chars(Date date) {
        return DateUtil.format(date, mFormat14chars);
    }
    ...
    public static String formatExpire(Date date) {
        return DateUtil.format(date, new SimpleDateFormat(mFormatExpire, local));
    }
    ...
    public static Date parseFormatIso8601Date(String date) {
        ...
        try {
            returnDate = new SimpleDateFormat(sdfLong).parse(date);
        } catch (Exception e) {
        }
        return returnDate;
    }
    ...
    public static String addDate(String date, String type, int into)
        ...
        try {
            ...
            Sdate = formatter.format(grc.getTime());
        } catch (Exception e) {
            throw e;
        }
        return Sdate;
    ...
    public static Date addDate(Date d, String type, int into) {
        GregorianCalendar grc = new GregorianCalendar();
        if (d == null) {
            d = new Date();
        }
    ...
    public static String addValidateDate(String date, String into)
        ...
        try {
            ...
            grc.setTime(new Date(date));
            grc.add(GregorianCalendar.DATE, Integer.parseInt(into));
            Sdate = new SimpleDateFormat(mFormatExpire, local).format(grc.getTime());
        } catch (Exception e) {
            throw e;
        }
        return Sdate;
    ...
    public static String addDayToStringDate(String formate, String strDate,
        ...
        try {
            ...
            long now = date.getTime() + Integer.parseInt(days)
                    * DAY_IN_MILLISECOND;
    ...
    public static Date fromStringToDate(Date date) throws ParseException {
        return new SimpleDateFormat(sdfLongTimePlus).parse(new SimpleDateFormat(sdfLongTimePlus).format(date));
    }
    ...
    /**
     * 获取指定日期所在月的第一天，2017-10-24
     */
    public static Date getDateOfFirstDayInMonth(Date date) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
        String temp = sdf.format(date);
        String firstDayInMoth = "";
        firstDayInMoth = temp + "-01";
        try {
            Date parse = sdf.parse(firstDayInMoth);
            return parse;
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    /**
     * 将日期 转为 yyyy-MM-dd 00:00:00
     *
     * @param
     * @return
     */
    public static Date getZoreDay(Date date) {
        try {
            return DateUtil.fromStringToDate("yyyy-MM-dd", DateUtil.dateToString(date, "yyyy-MM-dd"));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
    ...
    /**
     * 将日期 转为 yyyy-MM-dd 23:59:59
     *
     * @param
     * @return
     */
    public static Date getLastSecondsDay(Date date) {
        try {
            return DateUtil.fromStringToDate("yyyy-MM-dd HH:mm:ss", DateUtil.dateToString(date, "yyyy-MM-dd") + " 23:59:59");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static Integer differentDays(Date dateSmall, Date dateBig) {
        int days = (int) ((dateBig.getTime() - dateSmall.getTime()) / (1000 * 3600 * 24));
        return days;
    }
    ...
    public static Date getFirstMonthOfDate(Date date) {
        ...
        String temp = sdf.format(date);
        String firstDayInMoth = "";
        firstDayInMoth = temp + "-01 00:00:00";
        try {
            Date parse = sdf1.parse(firstDayInMoth);
            return parse;
        } catch (ParseException e) {
            e.printStackTrace();
            return date;
    ...
    public static String esFormatDate(Date date) {
        if (date == null) {
            return "";
        }
        String str = DateUtil.format(date, esFormatTime);
        str = str + " Z";
        return str;
    }
     ...
     * @return
     */
    public static Date getHourOfDate(Date date, Integer hour) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
